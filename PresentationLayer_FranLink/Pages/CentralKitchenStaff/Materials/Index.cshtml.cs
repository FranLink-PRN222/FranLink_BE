...
namespace PresentationLayer_FranLink.Pages.CentralKitchenStaff.Materials
{
    public class IndexModel : PageModel
    {
        ...
        public List<MaterialWithExpiryDto> Materials { get; set; } = new();
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            Materials = await _ckStaffService.GetMaterialsWithExpiryAsync(CentralKitchenId, ExpiringOnly);
