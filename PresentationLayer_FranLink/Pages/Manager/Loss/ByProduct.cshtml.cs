...
namespace PresentationLayer_FranLink.Pages.Manager.Loss
{
    public class ByProductModel : PageModel
    {
        ...
        public ByProductModel(ILossService lossService, FranLinkContext context)
        {
            _lossService = lossService;
            _context = context;
        }

        public List<LossByProduct> Products { get; set; } = new();
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            Products = await _lossService.GetLossByProductAsync(
